...
@pytest.mark.parametrize("group_size,expected", [
    (3, ['testapp ~/Data out/ participant --participant_label 10 11 12 -w work/sjob-0000  >> log/sjob-0000.log']),
    (2, ['testapp ~/Data out/ participant --participant_label 10 11 -w work/sjob-0000  >> log/sjob-0000.log',
         'testapp ~/Data out/ participant --participant_label 12 -w work/sjob-0001  >> log/sjob-0001.log']),
    (1, ['testapp ~/Data out/ participant --participant_label 10 -w work/sjob-0000  >> log/sjob-0000.log',
         'testapp ~/Data out/ participant --participant_label 11 -w work/sjob-0001  >> log/sjob-0001.log',
         'testapp ~/Data out/ participant --participant_label 12 -w work/sjob-0002  >> log/sjob-0002.log'])
])
